              ...
              <div class="card-body">
                ...
                <form role="form" class="text-start" action="/login" method="POST">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-success w-100 my-2 mb-2">Sign in</button>
                    <button type="Reset" class="btn bg-gradient-danger w-100 my-2 mb-2">Reset</button>
                  </div>
                </form>
              </div>
            </div>
