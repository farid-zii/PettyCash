            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="mx-3">
                        ...
                        <button class="btn bg-gradient-primary w-15 my-4 mb-2 float-sm-end" data-bs-toggle="modal"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="footer px-4 mb-2">
                    ...
                    <button type="button" class="btn btn-danger float-sm-end col-md-2 mt-4" data-bs-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
    </div>
